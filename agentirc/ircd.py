...
from agentirc._internal.telemetry import build_audit_record, current_traceparent
...
class IRCd:
    ...
    def __init__(self, config: ServerConfig):
        from agentirc._internal.telemetry import init_audit, init_metrics, init_telemetry
    ...
    def _bootstrap_system_identity(self) -> None:
        ...
        """
        from agentirc._internal.constants import SYSTEM_CHANNEL, SYSTEM_USER_PREFIX, SYSTEM_USER_REALNAME
