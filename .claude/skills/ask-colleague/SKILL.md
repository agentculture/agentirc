...
the inverse of the other skills under `.claude/skills/`, which agentirc vendors *from* guildmaster. See the *Skills* section of this repo's `CLAUDE.md`. The `cite, don't import`
