...
> - **Acceptance audit** ✅ (Task 14, post-PR-B4): walked all 11 §"Acceptance criteria" bullets against `main@5590256`. 9 of 11 pass directly; criteria 1–2 (real-PyPI install, TestPyPI dual-name install) are gated on Task 17's publish run and recorded as ⏳ deferred rather than ❌. Audit record: [`2026-05-01-task14-audit.md`](2026-05-01-task14-audit.md). No PR-B4.1 needed.
> - **Remaining**: 16–18 (tag `v9.4.0`, verify PyPI/TestPyPI publish, report-back to culture).
>
